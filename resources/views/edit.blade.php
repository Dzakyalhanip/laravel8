...
<div class="row">
    ...
    @method('PUT')
        <div class="row mb-3">
            ...
            <div class="col-sm-10">
            <input type="file" class="form-control" id="gambar" name="gambar"  value="{{$blogs->gambar}}">
            </div>
        </div>
        ...
        <div class="row mb-3">
            <label for="deskripsi" class="col-sm-2 col-form-label">Conten</label>
            <div class="col-sm-10">
            <input type="text" class="form-control" id="conten" name="conten"  value="{{$blogs->conten}}">
            </div>
        </div>
